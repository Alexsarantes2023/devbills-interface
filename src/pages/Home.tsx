  ...
  return (
    <div className="bg-gray-950 min-h-screen">
      <div className="container-app">
        <section className="py-12 md:py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Gerencie suas finanças com o
                <span className="text-primary-500">DevBills</span></h1>
        ...
        <section className="py-12 md:py-20 bg-gray-900 rounded-xl">
          <div className="container-app">
            <div className="text-center mb-12">
              ...
              <p className="tex-lg text-white max-w-2xl mx-auto">
                Nossa plataforma oferece tudo o que você precisa para manter suas finanças sob organizadas.
              </p>
            </div>

            {/* aqui sera meu map do array - obs: não precisa ser um estado porque não vai mudar*/}
        ...
        <section className="py12 md:py-20">
          <div className="bg-gray-900 p-8 md:p-12 rounded-xl text-center border border-gray-700">
            ...
            <p className="text-white tex-opacity-90 max-w-2xl mx-auto mb-8">
